    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-lg p-10 max-w-md w-full text-center">
          ...
          <button
            onClick={() => { setSuccess(''); setForm(f => ({ ...f, name: '', beneficiary: '', bankNorek: '', detailsOfPayment: '', project: '', description: '', notes: '' })); setItems([initialItem()]); }}
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-md overflow-hidden">
          ...
          {error && (
            <div className="mx-6 mb-4 px-4 py-3 bg-red-50 border border-red-200 text-red-700 rounded-lg text-sm">
              {error}
            </div>
          )}
